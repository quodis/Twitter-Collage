...
<meta name="keywords"
				content="<?= /* L10n: Meta tag keywords */ _('Mozilla, Firefox, Firefox 4, Party, Twitter, Tweet') ?>" />
<meta name="description"
				content="<?= /* L10n: Meta tag description */ _('Firefox 4 Twitter Party is an interactive visualization of Firefox 4 activity on Twitter.') ?>" />
...
<link rel="stylesheet" href="<?=$config['UI']['css']['minified']?>"
				type="text/css" media="screen, projection" />
	<?php } else { ?>
<link rel="stylesheet" href="<?=$config['UI']['css']['main']?>"
				type="text/css" media="screen, projection" />
<link rel="stylesheet" href="<?=$config['UI']['css']['mosaic']?>"
				type="text/css" media="screen, projection" />
	<?php } ?>

<link rel="shortcut icon" href="/favicon.ico" />
<link rel="apple-touch-icon" type="image/png"
				href="assets/images/global/apple-touch-icon-precomposed.png">
...
<script type="text/javascript"
	...
	<?php if ($config['UI']['minified']) { ?>
<script type="text/javascript"
				src="<?=$config['UI']['js']['minified']?>"></script>
	<?php } else { ?>
...
<style type="text/css">
<?=
				/* L10n: Replace this with your CSS rules to tweak the site in your locale */
_ ('placeholder{
...
<div class="wrapper clearfix"><!-- HEADER --> <header id="brand"
				role="banner"> <a href="/" title="<?= _('Start over') ?>"> <?= /* L10n: Logo translation. Feel free to change the order of the h1, h2 and p blocks. h1 max of 9 chars. h2 max of 13 chars. em max of 18 chars. */ _('<p><em>Join the</em></p><h1>Firefox 4</h1><h2>Twitter Party</h2>') ?>
</a> </header> <!-- CONTENT --> <aside id="main-content"
				class="clearfix"> <!-- Here goes the text explaining how Firefox Twitter Party works. -->
...
<dl>
				<dt><a
								href="http://twitter.com/share?url=http://mzl.la/hDx6aM&via=firefox&related=firefox&text=<?= urlencode( /* L10n: Default text to tweet */_('Join me at the Firefox 4 Twitter Party and celebrate the newest version') . ' #fx4 #teamfirefox') ?>"
								title="<?= /* L10n: Action verb, will open the new tweet window */ _('Tweet') ?>"
								rel="external"><?= _('Tweet') ?></a></dt>
				<dd><span></span></dd>
</dl>
</div>
<!-- twitter-counter -->
...
<input type="text" name="search-input" id="search-input"
				value="<?= /* L10n: This is an input placeholder. Users can only find exact twitter usernames */ _('Find a Twitter username') ?>"
				tabindex="1" />
<button type="submit" name="search-button" id="search-submit-bttn"
				value="<?= _('Find') ?>" tabindex="2" title="<?= _('Find') ?>"
				class="button"><?= _('Find') ?></button>
<div class="error">
...
<div id="download"><a class="download-link download-firefox"
				href="http://www.mozilla.com/"><span class="download-content"><span
				class="download-title">Firefox 4</span><?= /* L10n: Max of 15 chars */ _('Download here') ?></span></a>
</div>
<!-- download --> </aside><!-- main-content --> <section id="mosaic"
				role="img">
<h2><?= _('Mosaic') ?></h2>
...
<img src="" id="tile-hover" /> <article id="bubble" class="bubble"> <header>
...
<a href="#" title="" rel="author external" class="twitter-avatar"> <img
				src="" alt="<?= _('Twitter profile picture') ?>" width="48"
				height="48" /> </a> <time datetime="" pubdate><a href="#"
				rel="bookmark external" title="<?= _('Permalink') ?>"></a></time> </header>

<p></p>

</article><!-- bubble template --> </section><!-- mosaic --></div>
<!-- wrapper -->

<div id="mozilla-badge"><a href="http://www.mozilla.org/"
				class="mozilla" title="<?= _('Visit Mozilla') ?>" rel="external"><?= _('Visit Mozilla') ?></a>
</div>
<!-- mozilla-badge --></div>
<!-- container -->
...
<ul>
				<li id="footer-twitter"><a href="http://twitter.com/firefox"
								rel="external"><?= _('Twitter') ?></a></li>
				<li id="footer-facebook"><a href="http://Facebook.com/Firefox"
								rel="external"><?= _('Facebook') ?></a></li>
				<li id="footer-connect"><a href="/en-US/firefox/connect/"
								rel="external"><?= /* L10n: Max of 20 chars */ _('More Ways to Connect') ?></a></li>
</ul>

<p id="sub-footer-newsletter"><span class="intro"><?= /* L10n: Max of 30 chars*/ _('Want us to keep in touch?') ?></span>
<a href="http://www.mozilla.com/newsletter/"><?= /* L10n: Max of 25 chars */ _('Get Monthly News') ?>
<span>»</span></a></p>
...
<div id="footer-left">
<p id="footer-links"><a
				href="http://www.mozilla.com/privacy-policy.html"><?= _('Privacy Policy') ?></a>
&nbsp;|&nbsp; <a href="http://www.mozilla.com/about/legal.html"><?= _('Legal Notices') ?></a>
&nbsp;|&nbsp; <a
				href="http://www.mozilla.com/legal/fraud-report/index.html"><?= _('Report Trademark Abuse') ?></a>
</p>
...
<form id="lang_form" dir="ltr" method="get"><label for="flang"><?= _('Other Languages') ?></label>
